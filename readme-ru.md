...
Предупреждение: Чтобы использовать ReBar, вам потребуется **NVIDIA GeForce RTX 30-й серии** или **AMD RX 6000-й серии**, совместимый **процессор**, совместимая **материнская плата**.
