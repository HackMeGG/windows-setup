...
### 13.  Отключение результатов из интернета в поиске:
...
### 14.  Отключение фоновых приложениях: 
...
### 18.  Отключение Windows GameBar (WIN+G будет работать), использовать оба шага:
**Первый шаг**:
...
### 23. Отключение ненужных устройств в Диспетчере устройств:
...
### 24. Отключение автоматического перезапуска приложений при запуске системы:
...
### 28. Установите нужные вам программы.
### 29. Отключение ненужных приложениях из автозапуска.
### 30. Очистка системы:
...
### 32.  Отключаем автообновление приложений из магазина Microsoft Store:
...
### 33.  Отключение залипание клавиш:
...
### 38. Отключение диагностики Windows:
