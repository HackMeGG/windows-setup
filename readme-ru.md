...
Для этого нам потребуется программа **[O&O ShutUp10++]**(https://www.oo-software.com/en/shutup10). С помошью ней мы отключим некоторые шпионские сервисы Windows 10 и 11.
...
Служба диагностики позволяет обнаруживать и устранять проблемы связанные с работой Windows.
