...
**В конце** немного про гибернации.
...
### 20. Отключение диагностики Windows:
...
### 21. Политика кэширования записей:
...
### 30.  Отключение Windows GameBar (WIN+G будет работать), использовать оба шага:
**Первый шаг**:
...
### 37. Отключение значка уведомления на панели задач:
