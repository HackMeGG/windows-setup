...
### 20. Классическое контекстное меню правого клика мыши & отключить задержку показа меню в Windows 11:
...
### 25.  Отключение Защитника Windows (используйте все шаги):
