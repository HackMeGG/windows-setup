...
1.  Установите последние драйвера на чипсет, лан, вайфай & блютуз, звук, ГПУ (ниже представлена инструкция для установки чистого драйвера, можете просто установить драйвер без этой инструкции). Их можно взять с сайта материнской платы.

##### 2.1. Установка чистого драйвера на ГПУ:
...
Найти частоту вашей ГПУ можете на сайте [techpowerup](https://www.techpowerup.com/). Напишите в поиске вашу модель и зайдите на страницу, в самом внизу найдите свою модель видеокарты, вам нужно значение "**Boost Clock**".
...
12. Переключение видеокарту в режиме MSI: Скачайте [MSI utility v3](https://www.mediafire.com/file/ewpy1p0rr132thk/MSI_util_v3.zip/file) и запустите приложение от имени администратора → найдите вашу видеокарту и поставьте галочку в поле "**msi**", после чего нажмите "**Применить**".
</details>
...
#### 16. Отключение автоматического перезапуска приложений при запуске системы:
...
#### 18. Отключаем авто-обновление приложений из магазина Microsoft Store:
...
#### 19. Отключение Hyper-V (по желанию):
...
#### 20. Классическое контекстное меню ПКМ в Windows 11 & отключить задержку показа меню (по желанию):
...
#### 22. Отключить ненужные приложения из автозагрузки.

#### 23. Остановка слежки Windows (по желанию):
